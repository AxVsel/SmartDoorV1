...
char auth[] = "-FBBVIlkGVzBQi5u760MEpgg18oc6K6-";
...
void loop() {
  ...
  Blynk.notify("Ada orang di pintu");
  }
  ...
  Blynk.notify("Pintu terbuka dari dalam");
  prevMillis=millis();
  }
